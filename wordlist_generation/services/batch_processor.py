        ...
        try:
            ...
            if vocab_lang and vocab_n_words:
                ...
                pf = build_regexp_prefix_fn(
                    ...
                    allow_cohere_controls=self.model_service.is_cohere_reasoning_model,
                )
                if pf:
            ...
            if self.model_service.is_cohere_reasoning_model:
                ...
                for messages in messages_list:
                    ...
                    if enc["input_ids"].size(1) > self.settings.MAX_INPUT_TOKENS:
                        enc = truncate_inputs_to_max_length(enc, self.settings.MAX_INPUT_TOKENS)
                    encoded_list.append({
